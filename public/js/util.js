(function(global) {
	Lib = {
        ...
        uiReady : function(element, fn){
        	$(element).ready(fn);	
        },
        
        pageInitialized : function(fn){
        	$(document).ready(fn);
        },
	...
	DataTable = {
		create : function(table, fn){
			table.totalCount = 0;
			table.page = 1;
			table.totalPage = 0;
			table.fnLoad = fn;
			
			table.goPrev = function(){
		    	if(this.page <= 1)
		    		return;
		    	this.page--;	
		    	this.fnLoad();
		    ...
		    table.setItemCount = function(cnt, entries){
		    	this.totalCount =  cnt;
                
                if(this.totalCount > 0){
		         	this.page = 1;
		         	this.totalPage = Math.ceil(this.totalCount / entries);
		         }
		    }
		    return table;
		}
